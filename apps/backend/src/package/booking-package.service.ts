...
export class BookingPackageService {
  ...
  async createPackage(
    ...
    try {
      const newPackage = await this.prismaService.package.create({ data: data })
      if (!newPackage) {
  ...
  async updatePackagePrice(
    ...
    try {
      const newPackage = await this.prismaService.package.update({
        where: {
          id: id,
        },
        data: data,
  ...
  async deletePackage(id: string) {
    try {
      const updatedPackage = await this.prismaService.package.delete({
        where: {
          id: id,
        },
      })
